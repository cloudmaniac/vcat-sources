...
all of the key attributes necessary to be recognized as providing a cloud service. See _The_

_NIST Definition of Cloud Computing_ link in Section[ 7, References ](#_page45_x69.00_y72.00)for more information. **DHCP**  Dynamic Host Configuration Protocol (rfc2131 and updates) is a protocol that enables a host
...
**WAN Port Group** (_Backed by CE_

**Web Port Group App Port Group DB Port Group** _Access-VLAN_)
...
There are a number of alternative models for the placement of Edge Services Gateways on separate “Edge Clusters” without tenant workloads, each of which brings its own complexity and operational overhead. The principles outlined earlier in this section still apply, but must be applied on top of the Provider’s chosen Edge cluster option. The options are discussed in more detail in _Architecting a VMware vCloud Director Solution for VMware Cloud Providers (Section 6.3.2)._ See the Section[ 7, References ](#_page45_x69.00_y72.00)for more information.
...
_VMware vCloud Architecture Toolkit for_  [https://www.vmware.com/cloud-computing/cloud- ](https://www.vmware.com/cloud-computing/cloud-architecture/vcat-sp.html)_Service Providers_**  [architecture/vcat-sp.html ](https://www.vmware.com/cloud-computing/cloud-architecture/vcat-sp.html)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.178.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.179.png)

_vCloud Architecture Toolkit (vCAT) Blog_**  [https://blogs.vmware.com/vcat/ ](https://blogs.vmware.com/vcat/)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.180.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.181.png)

_Architecting a VMware vCloud Director_  [https://www.vmware.com/content/dam/digitalmar ](https://www.vmware.com/content/dam/digitalmarketing/vmware/en/pdf/vcat/vmware-architecting-a-vcloud-director-solution.pdf)_Solution for VMware Cloud Providers_  [keting/vmware/en/pdf/vcat/vmware-architecting-](https://www.vmware.com/content/dam/digitalmarketing/vmware/en/pdf/vcat/vmware-architecting-a-vcloud-director-solution.pdf)
...
_Customer Onboarding with VMware NSX_  [https://www.vmware.com/content/dam/digitalmar ](https://www.vmware.com/content/dam/digitalmarketing/vmware/en/pdf/vcat/vmware-customer-onboarding-with-nsx-l2vpn-services.pdf)_L2VPN Services for the VMware Cloud_  [keting/vmware/en/pdf/vcat/vmware-customer- ](https://www.vmware.com/content/dam/digitalmarketing/vmware/en/pdf/vcat/vmware-customer-onboarding-with-nsx-l2vpn-services.pdf)_Provider Program_  [onboarding-with-nsx-l2vpn-services.pdf ](https://www.vmware.com/content/dam/digitalmarketing/vmware/en/pdf/vcat/vmware-customer-onboarding-with-nsx-l2vpn-services.pdf) ![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.184.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.185.png)

_NIST Definition of Cloud Computing_  [http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistsp](http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-145.pdf)
...
_Forrester Leveraging Micro-Segmentation_  [https://www.vmware.com/ciovantage/article/forre ](https://www.vmware.com/ciovantage/article/forrester-report-available-zero-trust)_report_  [ster-report-available-zero-trust ](https://www.vmware.com/ciovantage/article/forrester-report-available-zero-trust)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.188.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.189.png)

_VMware NSX for vSphere Network_  [https://communities.vmware.com/docs/DOC- ](https://communities.vmware.com/docs/DOC-27683)_Virtualization Design Guide_  [27683 ](https://communities.vmware.com/docs/DOC-27683) ![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.190.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.191.png)

_Using the vCloud API to Grant Distributed_  [https://kb.vmware.com/selfservice/microsites/sea ](https://kb.vmware.com/selfservice/microsites/search.do?language=en_US&cmd=displayKC&externalId=2149016)_Firewall and Advanced Networking Services_  [rch.do?language=en_US&cmd=displayKC&exter ](https://kb.vmware.com/selfservice/microsites/search.do?language=en_US&cmd=displayKC&externalId=2149016)_Rights in vCloud Director 8.20_   [nalId=2149016 ](https://kb.vmware.com/selfservice/microsites/search.do?language=en_US&cmd=displayKC&externalId=2149016)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.188.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.189.png)

_Address Allocation for Private Internets_  [https://tools.ietf.org/html/rfc1918 ](https://tools.ietf.org/html/rfc1918) ![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.186.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.187.png)

_vCAN Product Usage Guide_  [https://vmware.my.salesforce.com/06980000000](https://vmware.my.salesforce.com/06980000000bpky)
...
**Internet Port Group** (_Backed by F/W Access-VLAN_)
...
1. Name and configure the new dvPortGroup.
...
1. After the new dvPortGroup is available in vCenter Server, it can be added as a new External Network within vCloud Director. In the External Networks view in the vCloud Director **Manage and Monitor** tab, click the green “plus” icon to open the **Add Network** dialog.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.219.png)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.220.png)

1. In the **Add Network** dialog, select the vCenter Server to show available vSphere networks, and select the new ACME_1_WAN network with the correct VLAN next to it.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.221.jpeg)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.222.png)

1. After the network appears in the lower table, click **Next** to continue.
...
1. Next configure the IP addressing details for the new network. This allows vCloud Director to understand the gateway address on the WAN CE router and the range of addresses on the new network which it can allocate.
...
1. Give the external network a name and description and click through to complete the dialog to finish adding the new external network.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.226.jpeg)

1. External networks are not confined to a single Organization within the Provider VDC in whose vCenter Server they are configured, so the service provider must take care with the next step which presents the new external network to the required Edge Services Gateway. From the **Actions** menu of the Edge Services Gateway, select **Properties**.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.227.jpeg)![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.228.png)

1. From the **Configure External Networks** tab of the Edge Services Gateway’s Properties dialog, select the new external network from the list in the top table of candidate networks and click **Add** to copy the network into the lower table of connected networks.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.229.jpeg)

1. On the **Configure IP Settings** tab, select the **Change IP Assignment** link on the new external network row to assign the address manually.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.230.jpeg)

1. In the **Change IP Assignment** dialog, set the **IP Assignment** mode to **Manual** and enter the required interface address.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.231.png)

1. If the new network is to be the Edge Services Gateway’s default route, the external network should be selected in **Configure Default Gateway** tab. Because the network is selected, the Default Gateway configured in Step 6 should appear in the right-hand column. After the changes are complete, click **OK** to close the dialog.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.232.jpeg)

1. After the infrastructure configuration is complete, the Edge Services Gateway might need additional changes to add extra static routes, configure peering over the new network, firewall rules or NAT entries. These configuration changes are carried out through the **Edge Gateway Services** option of the gateway’s **Actions** menu.

![](Aspose.Words.d9741dc5-ecea-4cef-a118-8fbd71c10c38.233.png)

1. And the options are then configured in new tab using the HTML5 interface.
